...
object CuratedShopsData {
    ...
    fun getCuratedShops(marketId: Long, marketName: String, lat: Double, lon: Double): List<Shop>? {
        ...
        return when {
            // 1. 서울 광장시장
            name.contains("광장시장") || name.contains("동대문광장") -> listOf(
            ...
            name.contains("속초관광수산") || name.contains("속초중앙시장") -> listOf(
            ...
            // 3. 강원 정선아리랑시장 (정선 5일장)
            name.contains("정선아리랑") || (name.contains("정선") && name.contains("5일")) -> listOf(
            ...
            name.contains("자갈치시장") || name.contains("국제시장") || name.contains("부평깡통") || name.contains("깡통시장") -> listOf(
            ...
            // 8. 충북 단양구경시장 (1, 6일장)
            name.contains("단양구경") || (name.contains("단양") && name.contains("구경")) -> listOf(
            ...
            name.contains("팔달문") || name.contains("못골시장") || name.contains("지동시장") || (name.contains("수원") && name.contains("남문시장")) -> listOf(
            ...
            // 11. 충북 제천 동문/중앙시장
            name.contains("제천동문") || name.contains("제천중앙") || name.contains("제천내토") || (name.contains("제천") && name.contains("전통시장")) -> listOf(
            ...
            // 12. 강원 강릉 성남/중앙시장 (강릉동부/서부시장 제외)
            name.contains("강릉성남") || name.contains("강릉중앙") -> listOf(
            ...
            // 13. 경북 포항 죽도시장
            name.contains("포항죽도") || name.contains("죽도시장") -> listOf(
            ...
            name.contains("모란민속") || name.contains("모란시장") -> listOf(
            ...
            // 15. 인천 신포국제시장
            name.contains("신포국제") || name.contains("신포시장") -> listOf(
            ...
            name.contains("서귀포매일올레") || name.contains("올레시장") -> listOf(
            ...
            name.contains("제주동문") || name.contains("동문재래") || name.contains("동문수산") -> listOf(
                Shop(marketId = marketId, shopName = "동문시장 진아떡집 (수제 오메기떡)", category = "먹거리", latitude = lat, longitude = lon, isOnnuri = true, onnuriType = "지류·카드·모바일", onnuriConfirmedCount = 36),
                Shop(marketId = marketId, shopName = "동문올레수산 (딱새우회·모둠회)", category = "식당", latitude = lat, longitude = lon, isOnnuri = true, onnuriType = "지류·카드·모바일", onnuriConfirmedCount = 31),
                Shop(marketId = marketId, shopName = "제주 동문 야시장 흑돼지떡갈비", category = "먹거리", latitude = lat, longitude = lon, isOnnuri = true, onnuriType = "지류·카드·모바일", onnuriConfirmedCount = 24),
                Shop(marketId = marketId, shopName = "동문시장 사랑분식 (사랑식 떡볶이·김밥)", category = "먹거리", latitude = lat, longitude = lon, isOnnuri = true, onnuriType = "지류·카드", onnuriConfirmedCount = 28)
            )

            // 17. 충북 청주 육거리종합시장
            name.contains("육거리종합") || name.contains("육거리시장") -> listOf(
            ...
            // 18. 경기 양평물맑은시장 (3, 8일장)
            name.contains("양평물맑은") || name.contains("양평시장") -> listOf(
            ...
            // 19. 전남 여수 서시장 / 교동시장
            name.contains("여수서시장") || name.contains("여수교동") || (name.contains("여수") && name.contains("서시장")) -> listOf(
            ...
            name.contains("통영중앙") || name.contains("통영서호") || name.contains("서호전통") -> listOf(
            ...
            // 22. 경북 문경 중앙시장 / 점촌시장
            name.contains("문경중앙") || name.contains("점촌시장") || name.contains("문경신흥") -> listOf(
            ...
            // 23. 경북 안동 구시장 / 신시장
            name.contains("안동구시장") || name.contains("안동신시장") || (name.contains("안동") && name.contains("중앙신시장")) -> listOf(
            ...
            // 24. 강원 춘천 중앙시장 / 낭만시장
            name.contains("춘천중앙") || name.contains("춘천낭만") || (name.contains("춘천") && name.contains("풍물시장")) -> listOf(
